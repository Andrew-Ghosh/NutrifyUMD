# NutrifyUMD
An app for UMD students that scrapes the nutrition facts for every food item from the UMD dining hall menu for a given week and outputs a meal plan to hit the user's dietary goals.
...
- **wants_workout_plan?:** yes  
  - **commitment_level:** 5 days/week, 1 hour/day
